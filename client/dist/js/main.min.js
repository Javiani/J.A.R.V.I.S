...
/******/ 			script.async = true;
/******/
/******/ 			script.src = __webpack_require__.p + "" + chunkId + "." + ({"0":"app"}[chunkId]||chunkId) + ".min.js";
	...
	* @param   { Object } options - set the propery overriding the default options
	...
	riot.Tag = Tag
	  ...
	  if (typeof exports === T_OBJECT)
	    module.exports = riot
	  else if ("function" === T_FUNCTION && typeof __webpack_require__(9) !== T_UNDEF)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jails = __webpack_require__(3);
	
	var _jails2 = _interopRequireDefault(_jails);
	...
	var jquerycdn = '//ajax.googleapis.com/ajax/libs/jquery/2.2.2/jquery.min.js';
	var app = document.getElementById('main-script').getAttribute('data-application');
	var dependencies = [app];
	
	(0, _scriptjs2.default)(jquerycdn, function () {
	
		if (!window.jQuery) {
			dependencies.unshift(jquery);
		}
	
		(0, _scriptjs2.default)(dependencies, function () {
			(0, _logger2.default)();
			_jails2.default.start();
		});
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = function( jails ){
